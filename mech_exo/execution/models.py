...
class Fill:
    ...
    # Execution quality
    reference_price: Optional[float] = None  # Price at time of order submission
...
def create_bracket_order(symbol: str, quantity: int, limit_price: float,
                        profit_target: float, stop_loss: float, **kwargs) -> List[Order]:
...
def validate_fill(fill: Fill) -> List[str]:
